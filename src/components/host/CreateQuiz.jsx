...
function CreateQuiz() {
  ...
  const handleHostQuiz = async () => {
    ...
    try {
      ...
      // Shuffle questions
      formattedQuestions.sort(
        () => Math.random() - 0.5
      );

      // --------------------------------
      // Create Quiz using Redux thunk
      // --------------------------------
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-slate-300 sm:text-base">
            Fetch exciting questions, prepare your
            quiz and invite players to battle! 🧠⚡
          </p>
        ...
        <div className="mb-6 rounded-3xl border border-white/10 bg-white/10 p-5 shadow-2xl backdrop-blur-xl sm:p-6">
          ...
          <div className="mb-5">
            ...
            <label className="mb-2 block text-sm font-bold text-indigo-200">
              Quiz Title
            </label>
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/10 bg-slate-950/40 px-4 py-3 text-white outline-none transition focus:border-indigo-400 focus:ring-2 focus:ring-indigo-500/20 placeholder:text-slate-500"
            />
          ...
          <div>
            ...
            <label className="mb-3 block text-sm font-bold text-indigo-200">
              Quiz Visibility
            </label>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              {questions.length > 0 && (
                <button
                  ...
                  className="group rounded-xl bg-linear-to-r from-emerald-500 to-green-600 px-6 py-3.5 font-bold text-white shadow-lg shadow-green-900/30 transition-all duration-200 hover:-translate-y-0.5 hover:from-emerald-400 hover:to-green-500 active:translate-y-0 disabled:cursor-not-allowed disabled:opacity-50"
                >
        ...
        {createdQuiz && (
          <div className="mb-6 rounded-2xl border border-emerald-400/20 bg-emerald-500/10 p-5 text-center">
          ...
          !error && (
            <div className="rounded-3xl border border-dashed border-white/20 bg-white/5 px-6 py-14 text-center backdrop-blur-md">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-400">
                ...
                to load questions and start
                building your Quiz Battle.
              </p>
        ...
        {questions.length > 0 && (
          <div className="mt-8 rounded-3xl border border-emerald-400/20 bg-linear-to-r from-emerald-500/10 to-blue-500/10 p-6 text-center backdrop-blur-xl">
            ...
            <p className="mt-1 mb-5 text-sm text-slate-400">
              Start the lobby and let your players
              join the quiz.
            </p>
            ...
            <button
              onClick={handleHostQuiz}
              disabled={!quizTitle.trim()}
              className="rounded-xl bg-linear-to-r from-emerald-500 to-green-600 px-8 py-3.5 font-black text-white shadow-lg shadow-green-900/30 transition-all duration-200 hover:-translate-y-0.5 hover:from-emerald-400 hover:to-green-500 disabled:cursor-not-allowed disabled:opacity-50"
            >
              🚀 Start Lobby & Host
            </button>
